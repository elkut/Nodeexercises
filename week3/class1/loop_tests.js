...
const readArrayWithMap = () => {
    ...
    return `Speed [map] : ${endMap - startMap} milseconds`;
};
...
export { readArrayWithMap, readArrayWithFor, readArrayWithForOf, readArrayWithForEach, };